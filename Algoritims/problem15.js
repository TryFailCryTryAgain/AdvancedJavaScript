...
// **Problem:** Implementera en Least Recently Used (LRU) cache med en maximal storlek.
//  När cachen är full ska det minst nyligen använda värdet tas bort.
...
// LocalStorage doesnt work in this use case bc it is a browser API
